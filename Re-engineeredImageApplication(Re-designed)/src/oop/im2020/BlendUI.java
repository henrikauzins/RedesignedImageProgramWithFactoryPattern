...
public class BlendUI extends JPanel {
    ...
    public BlendUI(final JFileChooser chooser) {
      ...
      //sets a border for pathPanel, colour chooser and alpha value slider
        ...
        alphaSlider.setBorder(BorderFactory.createTitledBorder("How close to match the image to blend through"));
    ...
    //these methods show the filchooser dialog box, gets the image path and the sensitivity value  
